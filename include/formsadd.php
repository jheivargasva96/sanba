                ...
                <div class="row clearfix progress-box">
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
                        <div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
                            <div class="project-info clearfix">
                                ...
                                <div class="project-info-right">
                                    <span class="no text-blue weight-500 font-24">Ingresar Liga</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                                ...
                                <a href="#" class="btn-block" data-backdrop="static" data-toggle="modal"
                                    data-target="#login-modal" type="button">
                        ...
                        <a href="#" class="btn-block" data-toggle="modal" data-target="#bd-example-modal-lg"
                            type="button">
                            <img src="vendors/images/modal-img1.jpg" alt="modal" class="mCS_img_loaded">
                        </a>
                    </div>
                </div>
            </div>
